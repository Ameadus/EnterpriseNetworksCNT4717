...
public class ResultSetTableModel extends AbstractTableModel   
{
   ...
   public ResultSetTableModel( String URL, String username, char[] password ) 
   ...
   {         
	    ...
	    try {
	    	...
	    	dataSource.setURL((URL)); //properties.getProperty
	    	dataSource.setUser((username)); //properties.getProperty
	    	dataSource.setPassword((new String(password))); 	 //properties.getProperty
