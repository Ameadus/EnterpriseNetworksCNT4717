...
<%@ page import="java.util.Vector" import="project4.*"  import="java.io.PrintWriter" language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
...
<body>
	...
	<div id="middle" style="text-align: center; color: green;">
		...
		<form method="POST" action="logic" name="logic">
			<textarea name="userInput" rows="10" cols="80" style="background-color: white;"></textarea>
			<br/>
